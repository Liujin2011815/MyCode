...
#define IIviFgenDataMarker_Configure(This,SourceChannel,BitPosition,Destination)	\
    ( (This)->lpVtbl -> Configure(This,SourceChannel,BitPosition,Destination) ) 
...
#define IIviFgenSparseMarker_Configure(This,WfmHandle,Indexes,Destination)	\
    ( (This)->lpVtbl -> Configure(This,WfmHandle,Indexes,Destination) ) 
